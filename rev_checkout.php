                        ...
                        <div class="col-50">
                            ...
                            <div class="row">
                                ...
                                <div class="col-50">
                                    ...
                                    <input type="text" min="3" max="3" id="cvv" name="cvv" placeholder="352" required>
                                </div>
...
{ 
    if($_SESSION['TKN_AMT'])
    {
        echo "<script>alert('Your token amount is {$tknseesion} successfully received... ')</script>";
        redirect('index.php');
    }
    else
    {
        echo "<script>alert('Something is went wrong please try later for checkout....')</script>";
    }
}
?>
